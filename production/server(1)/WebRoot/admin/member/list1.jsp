		...
		<tbody>
			...
			<!-- 
			 ...
			 -->
				...
				<td align="center" width="8%">经营牌照号码</td>
				<td align="center" width="8%">电话</td>
				<td align="center" width="8%">头像</td>
			...
			<c:forEach var="tmp" items="${lst}" varStatus="index">
						<tr>
							...
							<td class="altbg1" align="center">
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/user_chongzhi_in1.action?user.id=${tmp.id }">在线充值</a>
							<a target="mainFrame"
										href="${pageContext.request.contextPath}/user_del1.action?user.id=${tmp.id }">删除</a>
							</td>
