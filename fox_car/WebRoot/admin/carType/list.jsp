	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr class="header">
				...
				<td align="center" width="20%">能源类型</td>
				<td align="center" width="20%">品牌</td>
				<td align="center" width="20%">车辆类型</td>
			...
			<c:forEach var="tmp" items="${list}" varStatus="index">
						<tr>
							...
							<td class="altbg1" align="center">${tmp.id}</td>
							<td class="altbg1" align="center">	${tmp.type}</td>
							<td class="altbg1" align="center">	${tmp.pinpai}</td>
							<td class="altbg1" align="center">	${tmp.daxiao}</td>
							<td class="altbg1" align="center">
									<a target="mainFrame"
										href="${pageContext.request.contextPath}/carType_deleteCarType.action?carType.id=${tmp.id}">删除
									</a>
