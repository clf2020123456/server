...
<body leftmargin="0" rightmargin="0" topmargin="0"
	...
	<form action="biotech_savenews.action" method="post" enctype="multipart/form-data">
		...
		<table class="tableborder" align="center" cellpadding="4"
			...
			<tbody>
				<tr>
					<td colspan="2" class="header">添加资讯</td>
				</tr>
				<tr>
					<td class="altbg1" width="20%">资讯标题</td>
					<td class="altbg2">		<input name="biotech.title" value="${biotech.title }" type="text" /></td>
				</tr>
				<tr>
					<td class="altbg1" width="20%">作者</td>
					<td class="altbg2">		<input name="biotech.author" value="${biotech.author }" type="text" /></td>
				</tr>
				<tr>
					<td class="altbg1" width="20%">资讯内容</td>
					<td class="altbg2">		
					<textarea rows="4" cols="100" name="biotech.content">${biotech.content }</textarea>
					</td>
				</tr>
				<tr>
					<td class="altbg1" width="20%">图片上传</td>
					<td class="altbg2">	<s:file name="biotech.file" ></s:file></td>
				</tr>
